  ...
  return (
    <div className="min-h-screen bg-stone-100 text-zinc-900">
      ...
      <main className="pt-16">
        <section className="relative flex min-h-[calc(100vh-4rem)] min-h-[calc(100dvh-4rem)] items-center overflow-hidden bg-gradient-to-b from-stone-100 via-stone-100 to-stone-200/45 pt-1.5 sm:pt-2">
          ...
          <div className="container relative z-10 mx-auto w-full px-4 pb-8 pt-2.5 lg:px-6 md:pb-12 md:pt-4">
